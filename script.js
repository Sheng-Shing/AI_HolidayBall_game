...
function handleDisconnection() {
    ...
    bleConnectButton.textContent = '連接好樂球';
...
function handleBLEValue(event) {
    ...
    if (data[0] < 200) {
        ...
        if (packetType === 0x00) {
            leftCalibrate = data[2] * 256 * 256 + data[3] * 256 + data[4];
            rightCalibrate = data[5] * 256 * 256 + data[6] * 256 + data[7];
        ...
        let leftVal = data[2] * 256 * 256 + data[3] * 256 + data[4];
        let rightVal = data[5] * 256 * 256 + data[6] * 256 + data[7];
